    ...
    >
      <div className="container mx-auto px-4 max-w-6xl">
              ...
              <DialogTrigger asChild>
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-semibold text-foreground mb-2" data-testid={`text-cert-title-${cert.id}`}>
                      {cert.title}
                    </h3>
                    <p className="text-sm text-muted-foreground mb-2" data-testid={`text-cert-description-${cert.id}`}>
                      {cert.description}
                    </p>
                    <p className="text-xs text-muted-foreground/70" data-testid={`text-cert-number-${cert.id}`}>
                      {cert.number}
                    </p>
        ...
        <div className="mt-12 text-center">
          <Card className="inline-block rounded-xl bg-brand-light/20 border-brand-light">
