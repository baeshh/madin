...
export default function Footer() {
  return (
    <footer className="bg-muted/30 border-t border-border" data-testid="footer-main">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h3 className="font-semibold text-foreground mb-3">회사 정보</h3>
          ...
          <div>
            <h3 className="font-semibold text-foreground mb-3">연락처</h3>
            <div className="space-y-2 text-sm text-muted-foreground">
